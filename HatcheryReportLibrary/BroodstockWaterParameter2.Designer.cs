...
{
    partial class BroodstockWaterParameter2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sqlDataSource1.SelectCommand = "SELECT        Batch, Date, DO, PH\r\nFROM            BroodstockWaterParameter\r\nWHER" +
    "E        (Batch = @BatchParameter)";
            // 
            // graph1
            // 
            ...
            this.lineSeries1.DataPointLabel = "= Sum(Fields.DO)";
            this.lineSeries1.DataPointLabelStyle.Visible = false;
            this.lineSeries1.DataPointStyle.Visible = true;
            this.lineSeries1.LegendItem.Value = "= Fields.Batch + \'/\' + \'Sum(DO)\'";
            ...
            this.lineSeries2.Y = "= Sum(Fields.PH)";
            // 
            // BroodstockWaterParameter2
            // 
            this.Items.AddRange(new Telerik.Reporting.ReportItemBase[] {
            this.detailSection1});
            this.Name = "BroodstockWaterParameter2";
