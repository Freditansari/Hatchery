     ...
     <table>
	      <%--  <asp:Panel ID="PnlPrimaryKey" runat="server">
	        ...
	        <tr>
		        ...
		        <td colspan="2" class="auto-style1"><asp:DropDownList ID="DdlModuleName" runat="server" DataSourceID="ModuleSqlDataSource" DataTextField="ModuleName" DataValueField="ModuleName" AutoPostBack="True" AppendDataBoundItems="true" OnSelectedIndexChanged="DdlModuleName_SelectedIndexChanged"><asp:ListItem Value="">Select One</asp:ListItem></asp:DropDownList>
                </td>
	        </tr>
	        <tr>
		        <td>Production Cycle ID:</td>
                <td></td>
		        <td colspan="2"><asp:DropDownList ID="DdlProductionCycleID" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DdlProductionCycleID_SelectedIndexChanged"><asp:ListItem Value="">Select One</asp:ListItem></asp:DropDownList>
                    <asp:DropDownList ID="StartDateDDL" runat="server" AutoPostBack="True" OnDataBound="StartDateDDL_DataBound" OnSelectedIndexChanged="StartDateDDL_SelectedIndexChanged">
                    </asp:DropDownList>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="DdlProductionCycleID" ErrorMessage="Please Select a ProductionCycle" Operator="DataTypeCheck" Type="Integer">*</asp:CompareValidator>
                </td>
	        </tr>
	        <tr>
		        <td>Date:</td>
